            ...
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                        ...
                        // Carrega a lib de forma resiliente (não quebra a página se o
                        // módulo WhatsApp/Evolution ainda não estiver implantado).
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <select class="span12" name="status" id="status" value="">
                                                ...
                                                <option <?php if ($result->status == 'Não Realizado') { echo 'selected'; } ?> value="Não Realizado">Não Realizado</option>

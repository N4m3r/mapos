            ...
            <div class="widget-content nopadding tab-content">
                ...
                <form action="<?php echo current_url(); ?>" id="formServico" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="codigo_servico_municipio" type="text" name="codigo_servico_municipio" maxlength="6" value="<?php echo set_value('codigo_servico_municipio'); ?>" placeholder="6 dígitos (item da LC 116), ex: 140101" />
                        </div>
                    </div>
